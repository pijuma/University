...
main: 
	...
	add a1, x0, t3 # passa o valor de t3 para a1
...
add_node:
	...
	sw t6, 0(a0) # o valor armazenado em a0 passa a ser o valor de t6(chute feito)
...
primeiro_no:
	...
	sw t6, 0(a0) # o valor armazenado em a0 passa a ser o valor de t6(chute feito)
	sw x0, 4(a0) # a0 deve apontar para NULL (nao existe proximo item)
	sw a0, 0(t5) # t5 (head nesse momento) tera o valor de a0 (ponteiro)
